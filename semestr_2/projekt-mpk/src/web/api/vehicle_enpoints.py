...
async def add_vehicle(
    request: Request, vehicle_repository: AbstractVehicleRepository
) -> HTTPResponse:
    request_data = request.json
    vehicle = await add_vehicle_usecase(
...
async def get_vehicle(
    request: Request, vehicle_id: str, vehicle_repository: AbstractVehicleRepository
) -> HTTPResponse:
...
async def update_vehicle(
    ...
    request_data = request.json
    vehicle = await update_vehicle_use_case(
        vehicle_repository=vehicle_repository,
