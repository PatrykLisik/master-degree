...
from src.web.api.stop_usecase import (
    add_stop_usecase,
    add_time_between_stops_usecase,
    get_all_stop_usecase,
    get_stop_usecase
)
...
async def add_stop(request: Request, stop_repository: AbstractStopRepository) -> HTTPResponse:
...
async def add_time_between_stops(request: Request, stop_repository: AbstractStopRepository) -> HTTPResponse:
    request_data = request.json
...
async def get_stop(request: Request, stop_id, stop_repository: AbstractStopRepository) -> HTTPResponse:
...
async def get_all_stops(request: Request, stop_repository: AbstractStopRepository) -> HTTPResponse:
