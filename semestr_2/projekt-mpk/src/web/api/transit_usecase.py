...
async def add_transit_usecase(transit_repository: AbstractTransitRepository,
                        route_id: str,
                        start_time: datetime,
                        vehicle_id: str,
...
async def get_transit_usecase(transit_repository: AbstractTransitRepository, transit_id) -> Transit:
    return await transit_repository.get(transit_id)


async def get_all_transits_usecase(transit_repository: AbstractTransitRepository
                             ) -> List[Transit]:
