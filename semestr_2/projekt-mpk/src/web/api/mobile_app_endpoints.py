...
async def get_routes(request: Request, route_repository: AbstractRouteRepository) -> HTTPResponse:
...
async def get_route_stops(request: Request, route_id: str, route_repository: AbstractRouteRepository) -> HTTPResponse:
    stops = await get_route_stops_usecase(route_repository=route_repository,
                                          route_id=route_id)
...
async def get_route_stop_timetable(request: Request,
                                   route_id: str,
                                   stop_id: str,
                                   route_repository: AbstractRouteRepository,
                                   transit_repository: AbstractTransitRepository) -> HTTPResponse:
    time_table = await get_stop_timetable_usecase(route_repository=route_repository,
